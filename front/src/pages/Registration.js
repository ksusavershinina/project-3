        ...
        <div className={mode ? "container" : "container sign-in-mode"}>
            <div className="signin-signup">
                <form action="POST" className="sign-up-form">
                    ...
                    <input type="submit" value="Создать" className="btn" onClick={handleSubmit} />
                ...
                <form action="POST" className="sign-in-form">
                    ...
                    <button onClick={handleClick} className="no-fill-button" id="sign-up-btn">Создать аккаунт</button>
                </form>
            </div>
